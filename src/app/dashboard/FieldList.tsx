...
const FieldCard = ({ iconbg }: IconStylingProps) => {
  return (
    <Card className="flex flex-col p-4 gap-[10px] shadow-none">
      ...
      <CardContent className="flex flex-col p-0 gap-1 font-normal text-xs leading-normal">
    ...
    <div>
      <Card className="flex flex-col p-6 gap-[10px]">
        ...
        <CardContent className="grid grid-cols-3 gap-6 auto-rows-min p-0 ">
          <FieldCard />
          <FieldCard iconbg="bg-brand-yellow" />
          <FieldCard iconbg="bg-brand-brown" />
        </CardContent>
      </Card>
    </div>
  );
